...
*The course material is based on the workshops companion repository "[Witchcraft on Trial](https://github.com/Digital-History-Bielefeld/Witchcraft-on-Trial)". Special thanks to [Inga Kirschnick](https://github.com/IngaKirsche)*

This repository contains the materials and resources for chapter 3 of the Seminar "Grundlagen der Digital History".
...
**Section 2: Working with Python Libraries and functions**
...
**Section 3: Techniques for text analysis**
...
This course is designed for beginners with no prior programming experience. It covers the basics of Python programming and introduce you to some of the most common libraries used in the humanities. It will also provide you with some resources to help you continue learning on your own. **The most important thing is: do not be afraid to make mistakes, you can't break anything here.** Programming is a skill that takes time to develop, and the best way to learn is by doing. So don't be afraid to experiment and try new things. And also keep in mind that everyone has a different learning pace. So don't worry if you don't understand everything right away. Just keep practicing and most importantly: **have fun**!

## Getting started

The course is desined to be working with codespaces, so to start, you must set up a codespace.

Follow the instructions below to open your codespace and dive into a hassle-free and efficient development experience. Enjoy the course!

1. Click on the "Open in GitHub Codespaces" button below
2. A new browser tab opens where you will see some configuration options. Leave them as they are and click on the green "Create codespace" button.
4. You can see a Visual Studio Code environment. This is your codespace. You can now start working on the content of the first learning unit in the folder "section-1".

<p align="center">
    <a href="https://codespaces.new/Digital-History-Bielefeld/Introduction-to-Programming-with-Python" target="_blank"><img src="https://github.com/codespaces/badge.svg" alt="Open in GitHub Codespaces"></a>
</p>
