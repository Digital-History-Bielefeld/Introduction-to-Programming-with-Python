...
The aim of this Python crash course is to provide you with basic knowledge of the Python programming language. The intention is to give you ideas on how you can continue working with digital methods and take away an initial fear of programming. You should take as much in-depth knowledge as possible that can also be followed up at home and, above all, to bring the advantages of programming for humanities tasks closer. The repository is divided in four sections:
