# Working with Python Libraries and functions

You have learned some of the basics of Python in the first section:
- Variables
- Data types
- Operators
- Lists

In this section you will learn more about Python and its possibilities. You will learn about:
